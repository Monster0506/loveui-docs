...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (category.slug === "event-calendar") {
    return {
      title:
        "Event calendar component built with React and Tailwind CSS - loveui origin",
      description:
  ...
  return {
    title: isSingleComponent
      ? `${category.name} component built with React and Tailwind CSS - loveui origin`
      : `${category.name} components built with React and Tailwind CSS - loveui origin`,

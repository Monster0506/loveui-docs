...
import { categories } from "@/lib/page-templates-config/templates"
        ...
        <div className="px-4 text-center sm:px-6 lg:px-10">
          <div className="mx-auto max-w-3xl space-y-6">
            ...
            <PageHeaderDescription className="text-balance text-muted-foreground">
              Explore production-ready page templates crafted for modern dashboards, marketing sites, and internal tools.
            </PageHeaderDescription>
...
function CategoryCard({
  ...
  const href = `/page-templates/${slug}`
  const imageBasePath = `${basePath}/page-templates/thumbs/${slug}`
  const alt = `${name} templates`
  const isComingSoon = templatesCount === undefined

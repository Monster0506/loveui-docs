...
This guide provides the essentials for adding **loveui** components to your React application.
...
You can install all **loveui** primitives at once with a single command:
